...
botonproovedor3.onclick = function(){
  ...
  if(valid){
    ...
    if(numeroPedidos === 1){
      ...
      let pedido2Item = `*Hola!*  %0a%0a *PEDIDO: Prueba de tienda* %0a%0a— *[ ${cantidadUno} ]* ${productoUno} > *${precioUno}*%0a— *[ ${cantidadDos} ]* ${productoDos} > *${precioDos}* %0a %0a*Total:* ${total}%0aForma de pago: *${formaDePago}*%0a`;
      window.open("https://api.whatsapp.com/send/?text=" + pedido2Item);
    }
  }   
}
